...
const AddModal: React.FC<AddModalProps> = ({ onClose, ...rest }) => {
  // Ref to hold the content div, used to check if the click was inside or outside
  const modalContentRef = useRef<HTMLDivElement>(null);

  // --- Form State (kept for context) ---
  ...
  // --- NEW: Handler to close when clicking outside the content ---
  const handleBackdropClick = useCallback(
    (e: React.MouseEvent<HTMLDivElement>) => {
      // Check if the click originated on the backdrop itself (the outer div)
      // and not on a child element within the modal content
